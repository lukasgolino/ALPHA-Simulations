...
{	
  ...
  //Efficiencis of 4 Panels
  float lefteff = float(pmtNeweff);
  float righteff = float(pmtNeweff);

  float padEff = float(pmtNeweff);
  ...
  Float_t n=0., t1=0., p0_1=0., p1_1=0., p2_1=0., p3_1=0.;
  ...
  for(Int_t i=0; i<e; i++)
  {
    ...
    if( padEff > gRandom->Uniform() )
    {
      if(E>=threshold1)
      { 
        ++t1;
        if(padN==0.) ++p0_1; // back left
        else if(padN==1.) ++p1_1; // back right
        else if(padN==2.) ++p2_1; // front left
        else if(padN==3.) ++p3_1; // front right
        hKinTHRS1->Fill(kin);
        hTimeTHRS1->Fill(t);
  ...
  cout<<"----------------------------------------------------"<<endl;
  cout<<"hits with cut in energy "<<threshold1<<" MeV: "<<t1<<endl;
  cout<<"\t on the BACK LEFT PAD:\t"<<p0_1<<endl;
  cout<<"\t on the BACK RIGHT PAD:\t"<<p1_1<<endl;
  cout<<"\t on the FRONT LEFT PAD:\t"<<p2_1<<endl;
  cout<<"\t on the FRONT RIGHT PAD:\t"<<p3_1<<endl;
  cout<<"\t geometric scaling factor: "<<t1/NofEvents<<" +/- "<<sqrt(t1)/NofEvents<<endl;
  cout<<"----------------------------------------------------"<<endl;
  cout<<"----------------------------------------------------"<<endl;
  ...
  outfile<<"----------------------------------------------------"<<endl;
  outfile<<"hits with cut in energy "<<threshold1<<" MeV: "<<t1<<endl;
  outfile<<"\t on the BACK LEFT PAD:\t"<<p0_1<<endl;
  outfile<<"\t on the BACK RIGHT PAD:\t"<<p1_1<<endl;
  outfile<<"\t on the FRONT LEFT PAD:\t"<<p2_1<<endl;
  outfile<<"\t on the FRONT RIGHT PAD:\t"<<p3_1<<endl;
  outfile<<"\t e: "<<t1/NofEvents<<" +/- "<<sqrt(t1)/NofEvents<<endl;
  outfile<<"----------------------------------------------------"<<endl;
  outfile<<"----------------------------------------------------"<<endl;
  outfile.close();
...
void run_analysis(Int_t Nfile=4)
{
